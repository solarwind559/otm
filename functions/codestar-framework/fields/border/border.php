  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'top_icon'           => '<i class="fas fa-long-arrow-up"></i>',
        'left_icon'          => '<i class="fas fa-long-arrow-left"></i>',
        'bottom_icon'        => '<i class="fas fa-long-arrow-down"></i>',
        'right_icon'         => '<i class="fas fa-long-arrow-right"></i>',
