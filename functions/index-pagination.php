...
if ( ! function_exists( 'otm_theme_pagination' ) ) {
	function otm_theme_pagination() {
		...
		$paginate_links = paginate_links( array(
			...
			'mid_size' => 5,
			'prev_next' => True,
			'prev_text' => __('<i class="fas fa-angle-left"></i> Latest Posts', 'otm_theme'),
			'next_text' => __('Older Posts <i class="fas fa-angle-right"></i>', 'otm_theme'),
			'type' => 'list'
		) );
